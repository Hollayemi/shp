 ...
 */
export declare const CLEAR_VITE_CACHE_COMMAND = "rm -rf node_modules/.vite node_modules/.tmp && (touch src/index.css 2>/dev/null || touch src/App.css 2>/dev/null || true)";
/**
 ...
 */
export declare const createViteDevServerCommand: (port?: number) => string[];
/**
 ...
 */
export declare const getViteDevServerCommandDescription: (port?: number) => string;
