 ...
 */
export const CLEAR_VITE_CACHE_COMMAND =
  "rm -rf node_modules/.vite node_modules/.tmp && (touch src/index.css 2>/dev/null || touch src/App.css 2>/dev/null || true)";
 ...
 */
export const createViteDevServerCommand = (port: number = 5173): string[] => [
  "sh",
  "-c",
 ...
 */
export const getViteDevServerCommandDescription = (port?: number): string => {
