...
export function generateConvexAuthSecret(): string {
 ...
 */
export function generateConvexConfigTs(): string {
  return `/**
 ...
 */
export function generateBetterAuthComponentConfig(): string {
  return `/**
 ...
 */
export function generateBetterAuthStaticExport(): string {
  return `/**
 * Static Auth Export for Schema Generation
 ...
 */
export function generateBetterAuthAdapter(): string {
  return `/**
 ...
 */
export function generateAuthConfigTs(): string {
  return `/**
 ...
 */
export function generateAuthTsPhase1(): string {
  return `/**
 ...
 */
export function generateHttpTs(): string {
  return `/**
 * Convex HTTP Routes
 ...
 */
export function generateAuthClientTs(): string {
  return `/**
 ...
 */
export function generateBasicSchemaTs(): string {
  return `/**
 ...
 */
export function generateMainTsxWithAuth(): string {
 ...
 */
export function generateConvexTsConfig(): string {
  return `{
  "compilerOptions": {
    "target": "ESNext",
    "lib": ["ES2021", "DOM"],
 ...
 */
export async function generateConvexAuthJWTKeys(): Promise<ConvexAuthJWTKeys> {
...
export function generateBasicSchemaWithAuthTs(): string {
  return generateBasicSchemaTs();
}

/** @deprecated Use generateBasicSchemaTs instead */
export function generateSchemaWithAuthTs(_existingTables?: string): string {
  return generateBasicSchemaTs();
}

/** @deprecated Users are managed by Better Auth component */
export function generateUsersTs(): string {
