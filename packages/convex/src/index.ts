...
export {
  encryptDeployKey,
  decryptDeployKey,
  isValidDeployKeyFormat,
  getDeployKeyType,
  getDeploymentNameFromKey,
} from "./deploy-key-manager.js";
...
export {
  ...
  generateAuthTs,
  generateAuthTsPhase1, // For schema generation (no local schema import)
  generateHttpTs,
  generateAuthClientTs,
  generateBasicSchemaTs,
  generateMainTsxWithAuth,
  ...
  generateBetterAuthSchema, // Manual schema with admin plugin fields
  // Legacy exports (deprecated - kept for backwards compatibility)
  generateConvexAuthSecret,
  generateConvexAuthJWTKeys,
  generateBasicSchemaWithAuthTs,
  generateSchemaWithAuthTs,
  generateUsersTs,
